			...
			<div class="container">
				<div class="panel panel-default" style="margin:0 auto;width:500px">
					...
					<div class="panel-body">
						<form name="contactform" method="post" action="<?php echo URL; ?>home/contact" class="form-horizontal" role="form">
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<button type="submit" class="btn btn-default" name="sent_mail">
										Send Message
									</button>
								</div>
							</div>
